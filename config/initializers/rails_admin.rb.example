...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Service Health Dashboard', 'Admin']
  ...
  # config.excluded_models = ['Event', 'EventType', 'Service', 'Severity', 'Status', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Event', 'EventType', 'Service', 'Severity', 'Status', 'User']
  ...
  #     configure :informational, :boolean 
  ...
  #     configure :dependent_id, :integer 
  ...
  # config.model 'Severity' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your severity.rb model definition
  ...
  #     configure :severity, :belongs_to_association 
  ...
  #     configure :slug, :string 
  #     configure :description, :string 
  #     configure :severity_id, :integer         # Hidden 
